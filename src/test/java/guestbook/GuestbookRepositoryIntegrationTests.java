...
class GuestbookRepositoryIntegrationTests {
	...
	void persistsGuestbookEntry() {
		...
		GuestbookEntry entry = repository.save(new GuestbookEntry("Yoda", "May the force be with you!","fuckUtester"));
	...
	void findsGuestbookEntryByAuthorName() {
		...
		GuestbookEntry entry = repository.save(new GuestbookEntry("Yoda", "May the force be with you!","uckUtester"));
